# 🛡️ Mes Certifications Professionnelles

Ce dépôt regroupe l'ensemble de mes certifications obtenues en Cybersécurité, Réseaux et Administration Système.
...
* **[Fortinet Certified Fundamentals (FCF) Cybersecurity](./Lien-Vers-PDF)** - *Sept. 2025*
* **[NSE1 - Getting Started in Cybersecurity 3.0](./Lien-Vers-PDF)** - *Sept. 2025*
* **[FCF - Introduction to the Threat Landscape 3.0](./Lien-Vers-PDF)** - *Sept. 2025*
* **FortiWeb, FortiMail & FortiGate** (Modules de spécialisation)
...
* **[CRUD Operations in MongoDB](./Lien-Vers-PDF)** (MongoDB) - *Déc. 2025*
* **[Apply AI: Analyze Customer Reviews](./Lien-Vers-PDF)** (Cisco) - *Oct. 2025*

### 🏅 Autres Distinctions
* **ISC2 Candidate** - *Depuis Août 2025*
